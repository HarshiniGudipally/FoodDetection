...
datapath = '/content/drive/My Drive/frcnn/data_generation/train'
labelpath = '/content/drive/My Drive/frcnn/data_generation/labels'
classfilename = '/content/drive/My Drive/frcnn/data_generation/food.names'
